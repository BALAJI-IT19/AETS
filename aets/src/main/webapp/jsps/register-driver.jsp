...
<body>
	<form action="register-driver-controller.html">



		<div class="forHeading">Driver Registration Page</div>
		...
		<c:if test="${(error != 'success') && (error != null)}">
			...
			<div class="line-box">
			...
			</div> <label> <input type="text" class="input" name="lcNumber"
				...
				<div class="line-box">
				...
				</div> <label> <input type="text" class="input"
					name="carNumberPlate" placeholder="Enter Your Car number plate"
					required />
					...
					</div> <label> <input type="file" class="input" name="rcFile"
						required />
					...
					</label> <label> <input type="password" class="input"
							name="password" id="password" placeholder="Set Passowrd" required />
	...
	<center>
		<div id="outer">
			<p>
				<a href="register.html">Register as employee?</a>
			</p>
			<p>
